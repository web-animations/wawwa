 ...
 */
 ...
 (function() {
  ...
  /** @constructor */
  var RemotePlayerProxy = function(elemID, animEffect, timingDict, sequence, worker) {
    try {
  ...
  ProxyMap.prototype = {
    ...
    execute: function(inputs, worker) {
      var key = inputs[1] + inputs[2];
      var hold = this.findDict(key);
      if (!hold) {
        hold = new RemotePlayerProxy(inputs[1], inputs[3], inputs[4], inputs[2], worker);
        this.dict[key] = hold;
      }
